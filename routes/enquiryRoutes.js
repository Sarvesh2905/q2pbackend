...
/* ═══════════════════════════════════
   Enquiry Register (Table View)
═══════════════════════════════════ */
router.get("/register",          verifyToken, listEnquiries);
router.get("/register/filters",  verifyToken, getRegisterFilterOptions);
router.get("/register/download", verifyToken, downloadEnquiries);
